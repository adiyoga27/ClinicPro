    ...
    <div class="flex flex-col sm:flex-row gap-3 mb-6">
        ...
        <div class="flex gap-2">
            <button wire:click="pullFromSatuSehat" wire:loading.attr="disabled"
                ...
                class="px-5 py-3 bg-white dark:bg-surface-800 border border-surface-200 dark:border-white/10 text-surface-700 dark:text-surface-100 font-semibold rounded-xl shadow-sm hover:bg-surface-50 dark:hover:bg-surface-700/50 transition-all flex items-center justify-center gap-2 whitespace-nowrap">
